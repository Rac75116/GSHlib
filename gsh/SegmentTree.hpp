...
class SegmentTree : public ViewInterface<SegmentTree<Spec>, typename Spec::value_type> {
...
public:
    ...
    constexpr SegmentTree(InputIt first, InputIt last, Spec spec = Spec()) : spec(spec),
