...
template<class T = f64, class U>
constexpr T Norm(const Point2<U>& a) {
  return std::hypot(static_cast<T>(a.x), static_cast<T>(a.y));
}
template<class T>
constexpr T NormSquare(const Point2<T>& a) {
  return a.x * a.x + a.y * a.y;
}
template<class T>
constexpr T Dot(const Point2<T>& a, const Point2<T>& b) {
  return a.x * b.x + a.y * b.y;
}
template<class T>
constexpr T Cross(const Point2<T>& a, const Point2<T>& b) {
  return a.x * b.y + a.y * b.x;
}
template<class T, class U>
constexpr T NormSquare(const Point2<U>& a) {
  return static_cast<T>(a.x) * static_cast<T>(a.x) + static_cast<T>(a.y) * static_cast<T>(a.y);
}
template<class T, class U>
constexpr T Dot(const Point2<U>& a, const Point2<U>& b) {
  return static_cast<T>(a.x) * static_cast<T>(b.x) + static_cast<T>(a.y) * static_cast<T>(b.y);
}
template<class T, class U>
constexpr T Cross(const Point2<U>& a, const Point2<U>& b) {
  return static_cast<T>(a.x) * static_cast<T>(b.y) - static_cast<T>(a.y) * static_cast<T>(b.x);
}
template<class T = f64, class U>
constexpr T Angle(const Point2<U>& a) {
  return std::atan2(static_cast<T>(a.y), static_cast<T>(a.x));
}
template<class T = f64, class U, class V>
constexpr T Angle(const Point2<U>& a, const Point2<V>& b) {
  return std::atan2(static_cast<T>(Cross(a, b)), static_cast<T>(Dot(a, b)));
}
template<class T = f64, class U>
constexpr Point2<T> Rotate(const Point2<U>& a, const T& theta) {
...
template<class T = f64, class U>
constexpr T Norm(const Point3<U>& a) {
  return std::hypot(static_cast<T>(a.x), static_cast<T>(a.y), static_cast<T>(a.z));
}
template<class T>
constexpr T NormSquare(const Point3<T>& a) {
  return a.x * a.x + a.y * a.y + a.z * a.z;
}
template<class T>
constexpr T Dot(const Point3<T>& a, const Point3<T>& b) {
  return a.x * b.x + a.y * b.y + a.z * b.z;
}
template<class T>
constexpr Point3<T> Cross(const Point3<T>& a, const Point3<T>& b) {
  return {a.y * b.z - a.z * b.y, a.z * b.x - a.x * b.z, a.x * b.y - a.y * b.x};
}
template<class T, class U>
constexpr T NormSquare(const Point3<U>& a) {
  return static_cast<T>(a.x) * static_cast<T>(a.x) + static_cast<T>(a.y) * static_cast<T>(a.y) + static_cast<T>(a.z) * static_cast<T>(a.z);
}
template<class T, class U>
constexpr T Dot(const Point3<U>& a, const Point3<U>& b) {
  return static_cast<T>(a.x) * static_cast<T>(b.x) + static_cast<T>(a.y) * static_cast<T>(b.y) + static_cast<T>(a.z) * static_cast<T>(b.z);
}
template<class T, class U>
constexpr Point3<T> Cross(const Point3<U>& a, const Point3<U>& b) {
